...
На этом сервере стоит программа ОИК Диспетчер НТ для приема и обработки телеметрической информации, организация её хранения и доступ к результатам телеметрии и базам данных
